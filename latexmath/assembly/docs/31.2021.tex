...
Y &= RS(\overline{T}+PQ)
\end{align}
Now execute the following code using below link and upload in arduino to realize the Boolean logic for A with y being the input to A.
\begin{center}
\fbox{\parbox{13.5cm}{\url{https://github.com/Marikundam/fwc/tree/main/latexmath/assembly/assembly.asm}}}
\end{center}
\end{document}
